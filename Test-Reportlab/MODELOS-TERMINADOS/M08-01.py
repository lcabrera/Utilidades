...
M08_T01_DATA = m08_data.M08_T01_DATA

# Definimos las características de la tabla
M08_T01 = Table(M08_T01_DATA, colWidths=((PAGE_WIDTH - (LEFTMARGIN + RIGHTMARGIN)) / 34), splitByRow=1, repeatRows=1)
