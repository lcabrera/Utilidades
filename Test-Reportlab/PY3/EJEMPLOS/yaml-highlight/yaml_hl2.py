...
yaml.add_path_resolver(u'tag:yaml.org,2002:python/object:__main__.Style'
                       , [None], dict)
yaml.add_path_resolver(u'tag:yaml.org,2002:pairs', [None, u'replaces'],
                       list)
...
if __name__ == '__main__':
    ...
    parser.add_option(
        ...
        help='set an alternative configuration file',
        metavar='CONFIG',
        )
    parser.add_option(
        '-i',
        ...
        dest='input',
        default=None,
        help='set the input file (default: stdin)',
        metavar='FILE',
        )
    parser.add_option(
        '-o',
        ...
        dest='output',
        default=None,
        help='set the output file (default: stdout)',
        metavar='FILE',
        )
